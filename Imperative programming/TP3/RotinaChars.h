...
char RotinaDados(int tipo, int tamanho, int deci, char *nome){
    ...
    do{
        ...
        switch (tipo){
            ...
            case 5:{    //Tipo 5 – Números inteiros [48,56]
                ...
                if(entrada > 47 && entrada<58){ //Números inteiros [48,57]
                    nome[i]=entrada;
                    nome[i+1]=NULL;
                    clean();
            ...
            case 7:{    //Tipo 7 – Letras maiúsculas, minúsculas
            ...
            case 9:{    //Tipo 9 – codigo postal


                if(entrada > 47 && entrada < 58 || entrada==45){ //Números inteiros [48,56]

                        if(entrada==45){            //se for '-' entra.
                                if(deci==1){       //se a flag deci for 1, nao deixa escrever outro ponto.
                                    nome[i]=NULL;
                                    clean();
                                    printf("Entre com o numero:%s", nome);
            ...
            case 10:{ //Tipo 10 – Letras maiúsculas, minúsculas e números
                if(entrada > 96 && entrada < 123 || entrada== 32 || entrada > 64 && entrada < 91 || entrada > 47 && entrada < 58){
                    nome[i]=entrada;
                    nome[i+1]=NULL;
                    clean();
